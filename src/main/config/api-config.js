...
const apiConfigMixin = {
  ...
  addAPIProfile(profileData) {
    ...
    const newProfile = {
      ...
      serviceProvider: profileData.serviceProvider || 'kimi',
      description: profileData.description || '',
      baseUrl: profileData.baseUrl || 'https://api.kimi.com/coding/',
      selectedModelId: normalizeModelValue(profileData.selectedModelId) || 'kimi-for-coding',
