...
export default {
  ...
  main: {
    ...
    localMode: '本地模式',
    desktopUser: '桌面用户',
    warningText: 'Jedi 将访问所选项目文件夹中的文件。请确保您信任该项目目录。',
    settingsMenu: '设置',
    toggleDark: '切换深色',
    toggleLight: '切换浅色',
  ...
  rightPanel: {
    ...
    skills: {
      ...
      updateSuccess: '技能已更新',
      deleteSuccess: '技能已删除',
      visibilityUpdateFailed: '公开状态更新失败',
      makePublic: '设为公开',
      makePrivate: '设为私有',
      enable: '启用技能',
      disable: '禁用技能',
      ...
      sameNameOverridePlaceholder: '保留原 Skill ID，用可编辑副本覆盖内置版本',
      mustRenameHint: '必须使用不同的名称，避免源和目标同名冲突',
      sameNameOverrideHint: '可保留原 ID 创建同名可编辑副本；刷新后会优先使用该副本并隐藏内置版本',
      confirmCopy: '确认复制',
      ...
      importDesktopOnly: '导入技能需要使用桌面版应用',
      selectedSource: '已选择',
      validating: '校验中...',
      ...
      overwriteExistingSkills: '覆盖目标位置中同 ID 的技能',
      overwriteExistingSkillsHint: '仅覆盖当前导入目标里的同 ID 技能；同名但 ID 不同的技能仍会跳过',
    ...
    agents: {
      ...
      userAgents: '自定义全局',
      publicAgents: '公开 Agents',
      officialAgents: '官方 Agents',
      pluginAgents: '插件 Agents',
      editable: '可编辑',
      readonly: '只读',
      noProjectAgents: '暂无项目 Agents',
      noUserAgents: '暂无自定义 Agents',
      noPublicAgents: '暂无公开 Agents',
      noOfficialAgents: '暂无官方 Agents',
      uncategorized: '未分类',
      openFolder: '打开文件夹',
      openFile: '打开文件',
      // CRUD
  ...
  weixinNotify: {
    ...
    boundary: '该能力使用 Jedi 内建 iLink 通道；仅支持已扫码授权并被捕获为可发送目标的微信用户，不读取通讯录。',
    loginTitle: '通知目标授权',
    startLogin: '生成授权二维码',
  ...
  modelSettings: {
    ...
    addModel: '添加模型',
    selectProviderHint: '请从左侧选择一个模型提供商',
    notEnabled: '未开启',
    enabled: '已启用',
    apiKeyRequired: '请输入 API Key',
    modelsRequired: '请至少添加一个可用模型',
    testSuccess: '连接测试成功！',
    testFailed: '连接测试失败',
    saveSuccess: '保存成功',
    importFeature: '导入功能开发中...',
    exportFeature: '导出功能开发中...',
    addModelFeature: '添加模型功能开发中...',
    editProviderFeature: '编辑提供商功能开发中...',
    getApiKeyFeature: '获取 API Key 功能开发中...'
  },
  ...
  globalSettings: {
    ...
    outputBaseDirPlaceholder: '留空使用默认目录 ~/jedi-web-agent-output',
  ...
  agent: {
    ...
    welcomeDesc: '我是你的智能体，可以帮你完成各种任务。',
    ...
    uploadFile: '上传文件',
    fileLimitReached: '最多只能上传 {max} 个文件',
    fileTooLarge: '文件 {name} 过大（超过 {max}MB），已跳过',
    unsupportedFileType: '文件 {name} 不是支持的文本格式，已跳过',
    ...
    files: {
      ...
      previewSource: '查看源码',
      previewRendered: '预览渲染',
      textTips: 'Ctrl+S 保存',
      videoTips: '双击全屏 · 滚轮调节音量',
      videoNotSupported: '浏览器不支持此视频格式',
      audioTips: '点击播放 · 滚轮调节音量',
      audioNotSupported: '浏览器不支持此音频格式',
      officeTips: '支持 PDF/Word/Excel 预览',
      notebookTips: 'Jupyter Notebook 预览',
      officeUnsupported: '此文件格式暂不支持预览',
      pdfPreviewHint: 'PDF 文件较大，请在外部应用打开预览',
      save: '保存',
      unsaved: '未保存',
      saved: '已保存',
      // 右键菜单
    ...
    capTypeSkill: 'skill',
    capTypeAgent: 'agent',
    skillMentionTitle: '选择 skill',
    agentMentionTitle: '选择 agent',
    skillMentionNoMatch: '未找到匹配的 skill',
    agentMentionNoMatch: '未找到匹配的 agent',
    capDownload: '下载',
    capUpdate: '更新',
    capUninstall: '卸载',
  ...
  update: {
    ...
    clearDataConfirmTitle: '确认清除所有数据',
    clearDataConfirmDesc: '以下数据将被永久删除，此操作不可恢复：',
    clearDataItemSessions: '所有会话记录（Agent / 终端 / Notebook）',
    clearDataItemConfig: '应用配置（模型提供商、快捷键等）',
    clearDataItemFiles: '本地数据文件（notebook、输出目录等）',
    clearDataItemCache: '缓存与状态文件',
    clearDataSuccess: '数据已清除，请重启应用以完成初始化',
    clearDataFailed: '清除数据失败：{error}',
    latestVersion: '最新版本',
    releaseDate: '发布日期',
    releaseNotes: '更新日志',
    checkForUpdate: '检查更新',
  ...
  dingtalkSettings: {
    ...
    desktopOnly: '当前 Web 运行时仅支持保存钉钉配置；桥接连接需要在桌面端运行。',
    basicConfig: '基本配置',
    enableBridge: '启用钉钉桥接',
  ...
  feishuSettings: {
    title: '飞书桥接设置',
    description: '通过飞书机器人桥接，可以在手机飞书上直接与 Agent 模式对话。需要先在飞书开放平台创建企业自建应用并启用机器人。',
    desktopOnly: '当前 Web 运行时仅支持保存飞书配置；桥接连接需要在桌面端运行。',
    basicConfig: '基本配置',
    enableBridge: '启用飞书桥接',
    enableHint: '开启后，应用启动时自动连接飞书',
    appId: 'App ID',
    appIdPlaceholder: '请输入飞书应用的 App ID',
    appIdHint: '在飞书开放平台 → 应用信息中获取',
    appSecret: 'App Secret',
    appSecretPlaceholder: '请输入飞书应用的 App Secret',
    appSecretHint: '在飞书开放平台 → 应用信息中获取',
    notificationChatId: '兜底通知 Chat ID（可选）',
    notificationChatIdPlaceholder: '不使用微信通知兜底时可留空',
    notificationChatIdHint: '仅用于微信通知失败时转发到指定飞书会话；普通飞书机器人连接和对话不需要填写。',
    connectionControl: '连接控制',
    connect: '连接',
    reconnect: '重新连接',
    disconnect: '断开',
    ...
    activeSessions: '当前活跃会话: {count} 个',
    saveSuccess: '飞书配置已保存',
    connectSuccess: '飞书桥接连接成功',
    connectFailed: '飞书桥接连接失败',
    disconnected: '飞书桥接已断开',
    viewGuide: '查看使用指南',
    advancedSettings: '高级设置',
    maxHistorySessions: '历史会话数量',
    maxHistorySessionsHint: '飞书用户选择历史会话时显示的最大数量（1-20）',
  },
