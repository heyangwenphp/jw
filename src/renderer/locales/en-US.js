...
export default {
  ...
  main: {
    ...
    warningText: 'Jedi will access files in the selected project folder. Make sure you trust the project directory.',
  ...
  rightPanel: {
    ...
    skills: {
      ...
      noPublicSkills: 'No public skills',
      ...
      sameNameOverridePlaceholder: 'Keep the original Skill ID to override the built-in version with an editable copy',
      mustRenameHint: 'Must use a different name to avoid source/target conflict',
      sameNameOverrideHint: 'You can keep the original ID to create an editable same-name copy. After refresh, this copy takes precedence and the built-in version is hidden.',
      ...
      importDesktopOnly: 'Skill import requires the desktop app',
      ...
      overwriteExistingSkills: 'Overwrite skills with the same ID in the target',
      overwriteExistingSkillsHint: 'Only overwrites same-ID skills in the selected target. Same-name skills with different IDs are still skipped.',
    ...
    agents: {
      ...
      noPublicAgents: 'No public agents',
      noOfficialAgents: 'No official agents',
      uncategorized: 'Uncategorized',
      openFolder: 'Open folder',
      openFile: 'Open File',
      // CRUD
  ...
  im: {
    ...
    weixin: 'Weixin Notify',
    selectBotHint: 'Please select a bot',
    connected: 'Connected',
    disconnected: 'Disconnected'
  },
  ...
  weixinNotify: {
    ...
    boundary: 'This uses Jedi built-in iLink calls. It only supports Weixin users who scanned the authorization QR code and were captured as sendable targets; it does not read contacts.',
  ...
  modelSettings: {
    ...
    apiFormatHint: 'Please select API protocol format: Anthropic compatible or OpenAI compatible',
    testConnection: 'Test Connection',
    availableModels: 'Available Models',
    addModel: 'Add Model',
    selectProviderHint: 'Please select a model provider from the left',
    notEnabled: 'Not Enabled',
    enabled: 'Enabled',
    apiKeyRequired: 'Please enter API Key',
    modelsRequired: 'Please add at least one available model',
    testSuccess: 'Connection test successful!',
    testFailed: 'Connection test failed',
    saveSuccess: 'Saved successfully',
    importFeature: 'Import feature coming soon...',
    exportFeature: 'Export feature coming soon...',
    addModelFeature: 'Add model feature coming soon...',
    editProviderFeature: 'Edit provider feature coming soon...',
    getApiKeyFeature: 'Get API Key feature coming soon...'
  },
  ...
  globalSettings: {
    ...
    outputBaseDirPlaceholder: 'Leave empty to use default ~/jedi-web-agent-output',
  ...
  agent: {
    ...
    welcomeDesc: 'I\'m your agent, ready to help with various tasks.',
    ...
    fileLimitReached: 'Maximum {max} files allowed',
    fileTooLarge: 'File {name} too large (over {max}MB), skipped',
    unsupportedFileType: 'File {name} is not a supported text format, skipped',
    ...
    files: {
      ...
      audioTips: 'Click to play · Scroll to adjust volume',
      audioNotSupported: 'Browser does not support this audio format',
      officeTips: 'PDF/Word/Excel Preview Supported',
      notebookTips: 'Jupyter Notebook Preview',
      officeUnsupported: 'This file format is not yet supported',
      pdfPreviewHint: 'PDF file is large, please open in external app to preview',
      save: 'Save',
      unsaved: 'Unsaved',
      saved: 'Saved',
      // Context menu
    ...
    capTypeSkill: 'skill',
    capTypeAgent: 'agent',
    skillMentionTitle: 'Select skill',
    agentMentionTitle: 'Select agent',
    skillMentionNoMatch: 'No matching skill',
    agentMentionNoMatch: 'No matching agent',
  ...
  update: {
    ...
    clearDataConfirmTitle: 'Confirm Clear All Data',
    clearDataConfirmDesc: 'The following data will be permanently deleted. This action cannot be undone:',
    clearDataItemSessions: 'All session records (Agent / Terminal / Notebook)',
    clearDataItemConfig: 'App configuration (model providers, shortcuts, etc.)',
    clearDataItemFiles: 'Local data files (notebooks, output directories, etc.)',
    clearDataItemCache: 'Cache and state files',
    clearDataSuccess: 'Data cleared. Please restart the app to complete initialization.',
    clearDataFailed: 'Failed to clear data: {error}',
  ...
  dingtalkSettings: {
    ...
    desktopOnly: 'The current web runtime can only save DingTalk config. Bridge connection requires the desktop runtime.',
  ...
  // Feishu Bridge Settings
  feishuSettings: {
    title: 'Feishu Bridge Settings',
    description: 'Feishu robot bridge allows you to chat with Agent mode from your phone via Feishu. You need to create an enterprise self-built app on Feishu Open Platform and enable the robot.',
    desktopOnly: 'The current web runtime can only save Feishu config. Bridge connection requires the desktop runtime.',
    basicConfig: 'Basic Configuration',
    enableBridge: 'Enable Feishu Bridge',
    enableHint: 'Auto-connect to Feishu on app startup',
    appId: 'App ID',
    appIdPlaceholder: 'Enter Feishu app App ID',
    appIdHint: 'Found in Feishu Open Platform → App Info',
    appSecret: 'App Secret',
    appSecretPlaceholder: 'Enter Feishu app App Secret',
    appSecretHint: 'Found in Feishu Open Platform → App Info',
    notificationChatId: 'Fallback Chat ID (optional)',
    notificationChatIdPlaceholder: 'Leave empty unless you use Weixin notification fallback',
    notificationChatIdHint: 'Only used when Weixin notifications fail and should be forwarded to a Feishu chat. Normal Feishu bot bridge connection and chat do not require it.',
    connectionControl: 'Connection Control',
    connect: 'Connect',
    reconnect: 'Reconnect',
    disconnect: 'Disconnect',
    ...
    connectSuccess: 'Feishu bridge connected',
    connectFailed: 'Feishu bridge connection failed',
    disconnected: 'Feishu bridge disconnected',
    viewGuide: 'View Guide',
    advancedSettings: 'Advanced Settings',
    maxHistorySessions: 'History Sessions Limit',
    maxHistorySessionsHint: 'Maximum number of history sessions shown when Feishu user selects (1-20)',
  },
  ...
  app: {
    modes: {
      developer: 'Jedi Coder',
      agent: 'Jedi Agent',
      notebook: 'Jedi Notebook'
    },
    windowTitles: {
      main: '舆情监控',
