<template>
  <div class="file-tree-header panel-shell-header">
    <div class="header-left">
      ...
      <span v-if="showCwd && cwd" class="header-path" :title="cwd">{{ shortenPath(cwd) }}</span>
    </div>
...
defineProps({
  ...
  showCwd: { type: Boolean, default: true },
  showHidden: { type: Boolean, default: false },
  searchActive: { type: Boolean, default: false },
  showOpenExplorer: { type: Boolean, default: true },
