...
export function useTabManagement() {
  ...
  const ensureAgentTab = (agentSession) => {
    ...
    if (existingTab) {
      ...
      existingTab.source = agentSession.source || existingTab.source || null
      existingTab.reportMode = agentSession.reportMode || existingTab.reportMode || null
      existingTab.reportFilePath = agentSession.reportFilePath || existingTab.reportFilePath || null
      existingTab.preserveTitle = Boolean(agentSession.preserveTitle || existingTab.preserveTitle)
      existingTab.keepReportFollowupConversationVisible = Boolean(
        agentSession.keepReportFollowupConversationVisible ||
        existingTab.keepReportFollowupConversationVisible
      )
    ...
    const newTab = {
      ...
      source: agentSession.source || null,
      reportMode: agentSession.reportMode || null,
      reportFilePath: agentSession.reportFilePath || null,
      preserveTitle: Boolean(agentSession.preserveTitle),
      keepReportFollowupConversationVisible: Boolean(agentSession.keepReportFollowupConversationVisible),
